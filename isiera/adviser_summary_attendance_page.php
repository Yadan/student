...
<script>
    ...
    function exportToCSV() {
        ...
        fetchDetailedAttendanceRecords(subject, period, monthYearInput, teacher, studentName, studentLRN);
    }

    async function fetchDetailedAttendanceRecords(subject, period, monthYearInput, teacher, studentName, studentLRN) {
        try {
            const params = new URLSearchParams();
            ...
            createCSVWithDetails(subject, period, monthYearInput, teacher, studentName, studentLRN, detailedData);
        } catch (error) {
    ...
    function createCSVWithDetails(subject, period, monthYearInput, teacher, studentName, studentLRN, detailedData) {
        // Create CSV content
        ...
        csvContent += "\r\n\r\n=== DETAILED RECORDS ===\r\n";
        csvContent += "Date,Time In,Remarks\r\n";
        
        // Add detailed records
        if (detailedData && detailedData.length > 0 && detailedData[0].date !== 'No attendance records found') {
