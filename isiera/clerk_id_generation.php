...
// Include database connection - THIS WAS MISSING
        ...
        <tbody id="studentTableBody">
            ...
            foreach ($students as $student) {
                ...
                echo "<tr data-grade='".strtolower($student['grade_level'])."' style='display:none;'>
                    ...
                    <td>
                        <button class='view-btn' onclick=\"location.href='clerk_id_generate.php?gradelevel=".urlencode($student['grade_level'])."&section=".urlencode($student['section'])."'\">
